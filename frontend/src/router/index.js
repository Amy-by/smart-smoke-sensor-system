...
export const dynamicRoutes = [
  {
    ...
    children: [
      {
        path: 'sensor-list',
        component: () => import('@/views/iot/device/SensorList.vue'),
        name: 'IotSensorList',
        meta: { title: '传感器列表', icon: 'list', permissions: [] }
      },
      {
        path: 'sensor-detail',
        component: () => import('@/views/iot/device/SensorDetail.vue'),
        name: 'IotSensorDetail',
        meta: { title: '传感器详情', icon: 'component', permissions: [] }
      },
      {
        path: 'import-wizard',
        component: () => import('@/views/iot/device/ImportWizard.vue'),
        name: 'IotImportWizard',
        meta: { title: '批量导入', icon: 'upload', permissions: [] }
      },
      {
        path: 'alarm-monitor',
        component: () => import('@/views/iot/alarm/AlarmMonitor.vue'),
